...
- `GET /openapi.json` returns OpenAPI 3.0 specs for these endpoints.
...
- HTTP responses include permissive CORS headers (`Access-Control-Allow-Origin: *`) for browser access from any origin.
